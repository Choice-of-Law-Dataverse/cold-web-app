class Sorter:
    ...
    def sort_by_case_rank(self, data):
        ...
        court_decisions = (
            data.get("tables", {}).get("Court decisions", {}).get("results", {})
        )
        ...
        sorted_court_decisions = sorted(
            court_decisions_list, key=get_case_rank, reverse=True
        )
        ...
        sorted_results = {
            str(i): case_data
            for i, (key, case_data) in enumerate(sorted_court_decisions)
        }
