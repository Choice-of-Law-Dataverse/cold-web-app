<template>
  <div class="background">
    <div class="grid">
      ...
      <!-- Right Column -->
      <div class="text">
        <h2>The Choice of Law Dataverse is a Repository</h2>
        <p>
          CoLD contains carefully curated private international law data,
          helping experts stay up to date on legal changes across the world.
        </p>
      </div>
    </div>
  </div>
