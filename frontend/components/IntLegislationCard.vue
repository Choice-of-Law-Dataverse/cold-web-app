  ...
  >
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
      ...
      <div class="md:col-span-5">
        <div class="label-key">{{ keyMap.Provision }}</div>
        <div :class="valueClassMap.Provision || 'result-value'">
          {{ processedResultData.Provision || '[Missing Information]' }}
        </div>
      </div>
