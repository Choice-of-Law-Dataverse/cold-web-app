export const tooltips: Record<string, string> = {
  ...
  publicationDateIso:
    "Date of the decision's publication in the official reporter or official database.",
  dateOfJudgment:
    "Date on which the judgment was handed down. May differ from the publication date.",
  instance:
  ...
  choiceOfLawIssue:
    "The choice of law issue addressed by the court in the relevant area of private international law.",
  courtSPosition:
    "Court's analysis and conclusion as to the relevant choice of law issue.",
  quote:
    "Direct quote from the decision related to the choice of law issue. Translations are provided in square brackets.",
  relatedQuestions: "Questions that the court decision addresses.",
