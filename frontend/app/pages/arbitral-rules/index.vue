...
const columns: ColumnDef<Row>[] = [
  { accessorKey: "setofRules", header: "Set of Rules", enableSorting: true },
  { accessorKey: "inForceFrom", header: "In Force From", enableSorting: true },
  { id: "open", header: "", enableSorting: false },
];
