<template>
  <UCard class="overflow-hidden">
    ...
    <div
      ...
      :class="[
        isDragging
          ? 'border-cold-purple bg-cold-purple/10 scale-[1.02]'
          : selectedFile
            ? 'border-cold-teal bg-cold-teal/5'
            : 'hover:border-cold-purple/50 hover:from-cold-purple/5 hover:to-cold-teal/5 dark:hover:border-cold-purple/50 border-gray-200 bg-gradient-to-br from-gray-50 to-white dark:border-gray-700 dark:from-gray-800 dark:to-gray-900',
    ...
    >
      ...
      >
        <div
          class="from-cold-purple/20 absolute -top-8 -right-8 h-32 w-32 rounded-full bg-gradient-to-br to-transparent"
        />
        <div
          class="from-cold-teal/20 absolute -bottom-8 -left-8 h-32 w-32 rounded-full bg-gradient-to-tr to-transparent"
        />
      </div>
      ...
      <div class="relative px-8 py-12">
        ...
        <div class="mb-6 flex justify-center">
          <div class="relative">
            ...
            <div
              ...
              :class="[
                selectedFile
                  ...
                  : 'from-cold-purple/10 to-cold-teal/10 group-hover:from-cold-purple/20 group-hover:to-cold-teal/20 bg-gradient-to-br',
            ...
            <div
              v-if="!selectedFile"
              class="from-cold-purple to-cold-teal absolute -top-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-br opacity-0 transition-all duration-300 group-hover:opacity-100"
            >
              <svg
            ...
            <div
              v-if="!selectedFile"
              class="from-cold-teal to-cold-green absolute -bottom-1 -left-1 flex h-4 w-4 items-center justify-center rounded-full bg-gradient-to-br opacity-0 transition-all delay-100 duration-300 group-hover:opacity-100"
            >
              <svg
            ...
            <div
              v-if="selectedFile"
              class="bg-cold-green absolute -right-1 -bottom-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white shadow-lg dark:border-gray-800"
            >
        ...
        <div v-if="!selectedFile" class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            or
            <span
              class="text-cold-purple group-hover:text-cold-teal font-semibold transition-colors"
        ...
        <div v-else class="text-center">
          ...
          <p class="text-cold-teal mt-1 text-sm">
            {{ formatFileSize(selectedFile.size) }}
          </p>
          <button
            type="button"
            class="hover:text-cold-purple mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 transition-colors dark:text-gray-400"
...
function handleFileSelect(e: Event) {
  ...
  if (target.files && target.files.length > 0) {
    emit("update:selectedFile", target.files[0] as File);
  }
}
</script>
