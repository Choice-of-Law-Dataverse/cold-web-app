<template>
  <UCard id="questions-and-answers" class="cold-ucard overflow-visible">
    <div class="overflow-hidden">
      ...
      <div v-else-if="isSingleJurisdiction" class="divide-cold-gray divide-y">
        <div
          v-for="row in rows"
          :id="`question-${row.id}`"
          :key="row.id"
        ...
        >
          ...
          <div class="md:w-[40%] md:text-right">
            <NuxtLink
              v-if="row.answer"
              :to="row.answerLink"
              class="text-cold-purple font-semibold hover:underline"
            >
              {{ row.answer }}
            </NuxtLink>
      ...
      <div v-else>
        ...
        <div class="hidden md:block">
          <div class="divide-cold-gray divide-y">
            <div
              class="border-cold-gray flex gap-4 border-b-2 py-3 font-semibold"
            >
        ...
        <div class="divide-cold-gray block divide-y md:hidden">
          <div
            v-for="row in rows"
            :id="`question-${row.id}`"
            :key="row.id"
            ...
            <div class="flex flex-wrap gap-4">
              ...
              >
                ...
                <NuxtLink
                  ...
                  "
                  :to="getAnswerLink(jurisdiction.alpha3Code, row.id)"
                  class="text-cold-purple flex items-center gap-2 font-semibold hover:underline"
                >
                  <img
                    v-if="jurisdiction.avatar"
                    :src="jurisdiction.avatar"
