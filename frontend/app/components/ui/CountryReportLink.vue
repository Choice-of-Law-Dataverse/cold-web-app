<template>
  <DetailRow label="Country Report" class="mb-4">
    <NuxtLink
      ...
      class="bg-cold-purple/10 text-cold-night hover:bg-cold-purple/20 inline-flex items-center gap-2 rounded-full px-3 py-1 text-sm shadow-sm transition-colors hover:shadow-md"
    >
      <img
