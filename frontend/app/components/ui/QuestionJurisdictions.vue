        ...
        <DetailRow v-for="answer in answers" :key="answer" :label="answer">
          ...
          >
            <NuxtLink
              ...
              :key="country.code"
              class="label-jurisdiction text-cold-night hover:text-cold-purple inline-flex items-center whitespace-nowrap"
...
.region-badge {
  ...
  background-color: color-mix(in srgb, var(--color-cold-teal) 10%, transparent);
...
.region-badge:hover {
  background-color: color-mix(in srgb, var(--color-cold-teal) 20%, transparent);
}
